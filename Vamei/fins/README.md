...
cmp(2.3, 3.2)                    # 比较两个数的大小, does not work in pyhton3
...
long("23")                       # 转换为长整数 long integer. There is no 'long integer' in Python 3 anymore
str(2.3)                         # 转换为字符串 string
complex(3, 9)                    # 返回复数 3 + 9i
ord("A")                         # "A"字符对应的数值
chr(65)                          # 数值65对应的字符
unichr(65)                       # 数值65对应的unicode字符  Python3 use chr
...
reversed([1,5,3])                # 返回反序的序列，也就是[3,5,1] In python3 we use list(reversed([1,5,3]))
```
